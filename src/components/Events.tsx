  ...
  const events = [
    {
      ...
      description:
        "A national stock market simulation that makes finance interactive, engaging, and fun. Students will trade in a risk-free, gamified environment, learning how markets move, how trends shift, and how decisions shape outcomes.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "The iconic platform where bold ideas meet real opportunities. Students pitch their business ideas to a panel of investors and industry experts who offer mentorship, market exposure, and potential funding.",
      benefits: [
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    {event.registrationClosed && (
                      <span className="px-4 py-1 text-sm font-semibold bg-red-500/20 text-red-600 rounded-full">
                        Registration Closed
                      </span>
                    )}
                  </div>
