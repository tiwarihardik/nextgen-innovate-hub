    ...
    <section id="partners" className="py-20 bg-gradient-to-b from-background via-muted/20 to-background">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          {/* Hosted By */}
          <Card className={`p-8 md:p-12 bg-card/80 backdrop-blur-sm border-2 border-border hover:border-primary/30 hover:scale-105 transition-all duration-500 shadow-lg ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center">
                <img 
                  ...
                  className="h-24 md:h-32 w-auto object-contain hover:scale-110 transition-transform duration-300"
                />
              </div>
            </div>
          </Card>
          ...
          {/* Powered By */}
          <Card className={`p-8 md:p-12 bg-card/80 backdrop-blur-sm border-2 border-border hover:border-accent/30 hover:scale-105 transition-all duration-500 shadow-lg ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
