        ...
        <div className="text-center max-w-5xl mx-auto">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 bg-accent/10 text-accent rounded-full text-sm font-semibold mb-4">
              National Student Summit 2026
            </span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-to-r from-[hsl(25,95%,53%)] via-[hsl(12,88%,55%)] to-[hsl(211,100%,35%)] bg-clip-text text-transparent">
              GNU NEXTGEN
            </span>
            <br />
            <span className="text-foreground">SUMMIT 2026</span>
          </h1>
