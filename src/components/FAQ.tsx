...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The last date to register is 18th December 2025. We recommend registering early as spots are limited and will be allocated on a first-come, first-served basis."
    },
    {
